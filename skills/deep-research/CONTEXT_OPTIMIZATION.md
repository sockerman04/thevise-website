...
- [methodology.md]({project_path}/reference/methodology.md) - Loaded per-phase
- [report_template.md]({project_path}/templates/report_template.md) - Loaded for Phase 8 only
```
...
load("{project_path}/reference/methodology.md#phase-1-scope")
...
load("{project_path}/templates/report_template.md")
```
...
agent.context = {
    "query": user_query,
    "phase": "RETRIEVE",
    "instructions": load("{project_path}/reference/methodology.md#phase-3-retrieve"),
