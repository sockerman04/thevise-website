...
class ResearchEngine:
    ...
    def __init__(self, mode: ResearchMode = ResearchMode.STANDARD):
        ...
        # Use skill-relative path: {skill_path}/research_output
        skill_dir = Path(__file__).parent.parent
        self.output_dir = skill_dir / "research_output"
...
"""
    ...
    def execute_phase(self, phase: ResearchPhase) -> Dict[str, Any]:
        ...
        # In real usage, GLM will execute these instructions
        # This returns a structured result that GLM should populate
        result = {
            'phase': phase.value,
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Deep Research Engine for GLM",
...
Examples:
  ...
  python research_engine.py -q "longevity biotech funding trends" -m ultradeep
    ...
    print(f"\nNow GLM should execute each phase using the displayed instructions.")
