...
export default function Home() {
  ...
  const SECTION_MAP: Record<SectionKey, JSX.Element> = {
      ...
      <section ref={statsRef} className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">{home.burden.subheading}</p>
          </div>
          ...
          <div className="mt-12 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-8 max-w-4xl mx-auto">
            ...
            <div className="ml-11">
              <p className="text-gray-700 leading-relaxed mb-4">{home.burden.consequence.intro}</p>
              ...
              <p className="text-gray-700 leading-relaxed mt-4">{home.burden.consequence.outro}</p>
            </div>
          </div>
        </div>
      </section>
    ...
    problems: (
      <section className="py-20 bg-white">
        {/* unchanged block from your file */}
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
  ...
  const orderedSections = (home as any).sectionOrder as SectionKey[] | undefined
  const finalOrder: SectionKey[] =
    Array.isArray(orderedSections) && orderedSections.length
      ? orderedSections
      : ['hero', 'burden', 'solution', 'features', 'howItWorks', 'problems', 'credibility', 'contact']
